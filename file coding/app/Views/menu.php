      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?= base_url('home/stok_barang') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">Barang</div>
              </a>
              <ul class="menu-sub">
                <?php if (session()->get('level') == 1) { ?>
                <li class="menu-item">
                  <a href="<?= base_url('home/barang_masuk') ?>" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Barang Masuk</div>
                  </a>
                </li>
                <?php } ?>
                <li class="menu-item">
                  <a href="<?= base_url('home/barang') ?>" class="menu-link">
                    <div data-i18n="Text Divider">Barang</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bi bi-file-spreadsheet-fill"></i>
                <div data-i18n="User interface">Laporan</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?= base_url('home/laporan_transaksi') ?>" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Laporan Transaksi</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?= base_url('home/laporan_barang_masuk') ?>" class="menu-link">
                    <div data-i18n="Text Divider">Laporan Barang Masuk</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a
                ...
                class="menu-link"
              >
                <i class="menu-icon tf-icons bi bi-box-arrow-left"></i>
                <div>Log out</div>
              </a>
            </li>
          </ul>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <i class="bi bi-credit-card-2-front-fill fs-4 lh-0"></i>
